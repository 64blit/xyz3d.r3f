 ...
 *
 */
// const VideoFrame: React.FC<Props> = (props: Props) =>
export function VideoFrame(props: Props)
{
    const {
        width,
        height,
    ...
    return (
        <>
            <group name="spacesvr-frame">
                <mesh geometry={geometry} material={passedMaterial} />
