...
export function Frame(props: FrameProps) {
  const { width, height, thickness = 1, material: passedMaterial, innerFrameMaterial } = props
  ...
  return (
    <>
      <group name='spacesvr-frame'>
        ...
        {backFrameGeometry && innerFrameMaterial && <mesh geometry={backFrameGeometry} material={innerFrameMaterial} />}
      </group>
    </>
  )
}
